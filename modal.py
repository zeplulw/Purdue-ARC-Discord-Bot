...
class VerificationModal(Modal):
    ...
    def __init__(self) -> None:
        ...
        self.email_sender = EmailSender(os.getenv('EMAIL_ADDRESS'), os.getenv('EMAIL_PASSWORD'))
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        response = requests.request("POST", "https://www.purdue.edu/directory/Advanced", params={"SearchString": self.children[0].value,"SelectedSearchTypeId":"0","UsingParam":"Search by Email","CampusParam":"All Campuses","DepartmentParam":"All Departments","SchoolParam":"All Schools"})
        ...
        self.email_sender.send_email(interaction.user.name, receiver=self.children[0].value, verification_code=_verification_code)
